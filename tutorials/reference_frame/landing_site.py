    ...
    create_relative(
        create_relative(
            create_relative(
                ...
                landing_position,
                q_long),            # 把星球系转到发射场所在经度
            (0, 0, 0),          
            q_lat),                 # 继续转到纬度所在处
        (landing_altitude, 0, 0))

# Draw axes
conn.drawing.add_line((0, 0, 0), (100, 0, 0), landing_reference_frame)
conn.drawing.add_line((0, 0, 0), (0, 100, 0), landing_reference_frame)
conn.drawing.add_line((0, 0, 0), (0, 0, 100), landing_reference_frame)
